            ...
            <div class="ibox-content m-b-sm border-bottom">
                <div class="row">
                    <div class="col-lg-12 text-right">
                        ...
                        <a href="/user/add" class="btn btn-w-m btn-default"><i class="fa fa-plus"></i> 添加用户</a>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable">
                                ...
                                <c:forEach items="${pageInfo.list}"  var="user">
                                    <tr >
                                        ...
                                        <td>${user.group.roleName}</td>
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a class="btn btn-default btn-sm" href="/user/edit/${user.id}"><i class="fa fa-paste"></i> 修改</a>
                                                <a class="btn btn-default btn-sm" href="/user/delete/${user.id}" onclick="if(confirm( '您确定要删除吗？')==false)return   false;"><i class="fa fa-trash"></i> 删除</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
