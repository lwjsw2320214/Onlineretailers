            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ibox-content">
                        <form:form action="/user/add" cssClass="form-horizontal"  modelAttribute="user">
                            <div class="form-group">
                            <label class="col-sm-2 control-label">所在部门：</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <form:input path="office.officeName"  cssClass="form-control parentName"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <form:input path="group.roleName" cssClass="form-control"/>
