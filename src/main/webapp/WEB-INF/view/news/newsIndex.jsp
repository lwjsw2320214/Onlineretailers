    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="ibox-content m-b-sm border-bottom">
                <div class="row">
                    <form:form class="form-horizontal" modelAttribute="article" action="/article/news" method="get">
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 text-right">
                                ...
                                <a href="/article/newsAdd" class="btn btn-w-m btn-default"><i class="fa fa-plus"></i> 添加新闻</a>
                            </div>
                        </div>
                    </form:form>
                </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable">
                                ...
                                <c:forEach items="${pageInfo.list}"  var="article">
                                    <tr >
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a class="btn btn-default btn-sm" href="/article/newsEdit/${article.id}"><i class="fa fa-paste"></i> 编辑</a>
                                                <a class="btn btn-default btn-sm" href="/article/newsDelete/${article.id}" onclick="if(confirm( '您确定要删除吗？')==false)return   false;"><i class="fa fa-trash"></i> 删除</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
